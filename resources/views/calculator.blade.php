...
<head>
  ...
  <style>
    body {
      ...
      background: #f2f2f7;
      color: #333;
      font-size: 16px; /* Ensure text is large enough to avoid zooming */
    }

    /* Container to simulate a native app screen */
    .app-container {
      display: flex;
    ...
    /* Card-like containers for form and results */
    .card {
      background: #fff;
      border-radius: 12px;
      padding: 1rem;
    ...
    <div class="content">
      ...
      <div class="card" id="inputSection">
        ...
        <div id="financingForm" style="display:none;">
          Financing form will be updated later.
        </div>
