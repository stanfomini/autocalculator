...
<body>
  <div class="app-container">
    <div class="app-header">
      ...
      <!-- Added links to the new routes -->
      <p>
        <a href="/test" style="font-size: 0.9rem; color: blue;">Go to Test Feature</a> |
        <a href="/hello" style="font-size: 0.9rem; color: green;">Go to Hello Feature</a>
      </p>
    </div>
    <div class="content">
